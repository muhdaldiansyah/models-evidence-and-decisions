...
| | |
|---|---|
| Chapter | **Measurement and Operationalization** |
| Manuscript | complete — 7 sections, 9,339 words |
| Budget | 26 pages / 5 learning hours |
...
| Terminology block | provisional, pending [Decision 0010](../../decisions/0010-chapter3-measurement-terminology-and-boundary.md) |
...
**Four competing operationalizations of one word.** The pilot's specific question is whether a reader can hold four at once, or whether they collapse them into two by the end of the chapter. The systematic-offset demonstration is the chapter's sharpest moment and the most likely to be misread as an instrument-quality point rather than an interpretation point.
...
6. **Chapter audit.** The 26-page / 5-hour architecture holds unless evidence justifies reopening it; all 7 sections still serve their governed jobs; central question and core competence intact; reveal order coherent; citation keys resolve and source-note cautions are respected; no exercise exposes an answer, rubric, or parallel form before production.
7. **Freeze decision.** `FREEZE` · `FREEZE WITH DEFERRED NON-BLOCKING ITEMS` · `REVISE AND RE-PILOT` · `REOPEN GOVERNED DECISION`.

**Gate 7 additionally requires that [Decision 0010](../../decisions/0010-chapter3-measurement-terminology-and-boundary.md) has been adjudicated.** This chapter's terminology and scope are provisional until it is, and a chapter cannot freeze on a provisional boundary.
