...
| | |
|---|---|
| Chapter | **Combining and Transporting Evidence** |
| Manuscript | complete — 7 sections, 9,383 words |
...
| Terminology block | provisional, pending [Decision 0016](../../decisions/0016-chapter9-synthesis-terminology-and-boundary.md) |
...
**The smallest chapter in Part II, deliberately.** Its Gate 1 question is narrow and load-bearing: whether static lift versus friction loss is a real terrain-dependent distinction. The transport argument does not survive without it. The pilot question is whether 28 pages is enough for a chapter seven earlier chapters deferred to.
...
**Gate 7 additionally requires that [Decision 0016](../../decisions/0016-chapter9-synthesis-terminology-and-boundary.md) has been adjudicated.** This chapter's terminology and scope are provisional until it is, and a chapter cannot freeze on a provisional boundary.
