...
| | |
|---|---|
| Chapter | **Sequential Decisions, Information, and Control** |
| Manuscript | complete — 8 sections, 9,466 words |
| Budget | 28 pages / 6 learning hours |
...
| Terminology block | provisional, pending [Decision 0021](../../decisions/0021-chapter14-sequential-control-terminology-and-boundary.md) |
...
**Gate 1 wants leakage or network-analysis experience**, and its central question is whether the chapter's observability claim is a straw man. If a utility of this size would in fact have the instrumentation to tell hot-weather demand from a burst, the chapter's core demonstration collapses. That is a mechanism question, not a wording question.
