...
## Chapters 2–6 — proposed, not yet adjudicated
...
Records 0001–0008 are **Accepted**. Records 0009–0013 are **PROPOSED and not author-adjudicated**; the chapter specifications, terminology entries, and manuscripts built on them inherit that status.

**The item most in need of adjudication is 0013 clause 2.** It is the only decision in the set that reverses a policy the book has held since Chapter 1, and the manuscript announces the reversal to the reader in §2. If the exception is refused, Chapter 6 §§2–4 require rewriting rather than editing.
