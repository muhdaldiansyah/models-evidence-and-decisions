...
## Chapters 2–7 — proposed, not yet adjudicated
...
Records 0001–0008 are **Accepted**. Records 0009–0014 are **PROPOSED and not author-adjudicated**; the chapter specifications, terminology entries, and manuscripts built on them inherit that status.

**The items most in need of adjudication are 0013 clause 2 and 0014 clause 2.** Together they reverse a policy the book held from Chapter 1 through Chapter 5, and both manuscripts announce the reversal to the reader. They must be adjudicated in order: 0014's exception extends 0013's, so ruling on the second without the first would be incoherent. If either is refused, the affected sections require rewriting rather than editing — Chapter 6 §§2–4, and Chapter 7 §3.
