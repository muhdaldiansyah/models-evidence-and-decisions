...
**To read the book.** **Parts I, II, and III are complete** — twelve chapters, written to be read in order:
...
All twelve work one case: a small municipal water utility during a seven-day heatwave.
...
- [`decisions/`](decisions/) — settled decisions and their reopening conditions, indexed by scope: three book-level, five governing Chapter 1, and eleven proposed for Chapters 2–12.
...
Chapter 1's directory, still the most developed, shows the kinds of file a chapter accumulates. Chapters 2–12 carry the same kinds, minus the validation instruments and with their research split across separate dossiers rather than a single notes file.
...
- **Research and drafting** — `drafting-blueprint.md`, plus `notes.md` in Chapter 1 and `readiness-audit.md`, `research-plan.md`, and numbered `research-0N-*.md` dossiers in Chapters 2–12.
...
- Chapters 13–17 exist as skeleton specs: governed title, central question, core competence, and page and hour targets, with content architecture still open.
