...
**To read the book.** **Parts I through IV are complete** — fifteen chapters, written to be read in order:
...
All fifteen work one case: a small municipal water utility during a seven-day heatwave.
...
- [`decisions/`](decisions/) — settled decisions and their reopening conditions, indexed by scope: three book-level, five governing Chapter 1, and fourteen proposed for Chapters 2–15.
...
Chapter 1's directory, still the most developed, shows the kinds of file a chapter accumulates. Chapters 2–15 carry the same kinds, minus the validation instruments and with their research split across separate dossiers rather than a single notes file.
...
- **Research and drafting** — `drafting-blueprint.md`, plus `notes.md` in Chapter 1 and `readiness-audit.md`, `research-plan.md`, and numbered `research-0N-*.md` dossiers in Chapters 2–15.
...
- Chapters 16–17 exist as skeleton specs: governed title, central question, core competence, and page and hour targets, with content architecture still open.
